    ...
    <table id="scroll-table" v-scrolltable="">
      ...
      <tbody>
        <tr v-for="app in sortedTools">
          ...
          <td v-tooltip.bottom-center="app.handoff.surveyRaw2017 + ' votes in 2017<br>Design Tools Survey'">
            <a href="/survey-2017" style="display: block;">
              <div
                v-bind:class="[{'blue-bar' : app.handoff.surveyRaw2017}, 'bar']"
                v-bind:style="{ width: app.handoff.surveyPercent2017 + '%' }">
              </div>
            </a>
          </td>
          <td class="colspan-3">
          ...
          <td>
            <div v-if="app.handoff.specs" v-tooltip.bottom-center="'Specs'"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg>
            </div>
          </td>
          <td>
            <div v-if="app.handoff.automatic" v-tooltip.bottom-center="'Automatic'"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg>
            </div>
          </td>
          <td>
            <div v-if="app.handoff.assets" v-tooltip.bottom-center="'Assets'"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg>
            </div>
          </td>
          <td>
            <div v-if="app.handoff.measure" v-tooltip.bottom-center="'Measure'"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg>
            </div>
          </td>
          <td>
            <div v-if="app.handoff.variables" v-tooltip.bottom-center="'Variables'"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg>
            </div>
          </td>
          <td>
            <div v-if="app.handoff.styleguide" v-tooltip.bottom-center="'Variables'"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg>
            </div>
          </td>
          <td>
            <div v-if="app.handoff.guides" v-tooltip.bottom-center="'Guides'"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg>
            </div>
          </td>
          <td>
            <div v-if="app.handoff.layers" v-tooltip.bottom-center="'Layers'"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg>
            </div>
          </td>
          <td>
            <div v-if="app.handoff.comments" v-tooltip.bottom-center="'Comments'"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg>
            </div>
          </td>
          <td>
            <div v-if="app.handoff.revisions" v-tooltip.bottom-center="'Revisions'"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg>
            </div>
          </td>
          <!-- <td class="colspan-2">
            <div class="flex-col">
