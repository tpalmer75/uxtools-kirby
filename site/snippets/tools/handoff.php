    ...
    <table id="scroll-table" v-scrolltable="">
      ...
      <tbody>
        <tr v-for="app in sortedTools">
          ...
          <td>
            <div v-html="getCheckIcon(app.handoff.specs.capable)">
            </div>
            <p class="notes" v-html="app.handoff.specs.notes"></p>
          </td>
          <td>
            <div v-html="getCheckIcon(app.handoff.automatic.capable)">
            </div>
            <p class="notes" v-html="app.handoff.automatic.notes"></p>
          </td>
          <td>
            <div v-html="getCheckIcon(app.handoff.assets.capable)">
            </div>
            <p class="notes" v-html="app.handoff.assets.notes"></p>
          </td>
          <td>
            <div v-html="getCheckIcon(app.handoff.measure.capable)">
            </div>
            <p class="notes" v-html="app.handoff.measure.notes"></p>
          </td>
          <td>
            <div v-html="getCheckIcon(app.handoff.variables.capable)">
            </div>
            <p class="notes" v-html="app.handoff.variables.notes"></p>
          </td>
          <td>
            <div v-html="getCheckIcon(app.handoff.styleguide.capable)">
            </div>
            <p class="notes" v-html="app.handoff.styleguide.notes"></p>
          </td>
          <td>
            <div v-html="getCheckIcon(app.handoff.guides.capable)">
            </div>
            <p class="notes" v-html="app.handoff.guides.notes"></p>
          </td>
          <td>
            <div v-html="getCheckIcon(app.handoff.layers.capable)">
            </div>
            <p class="notes" v-html="app.handoff.layers.notes"></p>
          </td>
          <td>
            <div v-html="getCheckIcon(app.handoff.comments.capable)">
            </div>
            <p class="notes" v-html="app.handoff.comments.notes"></p>
          </td>
          <td>
            <div v-html="getCheckIcon(app.handoff.revisions.capable)">
            </div>
            <p class="notes" v-html="app.handoff.revisions.notes"></p>
          </td>
          <!-- <td class="colspan-2">
            <div class="flex-col">
