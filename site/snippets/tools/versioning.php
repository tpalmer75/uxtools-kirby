    ...
    <table id="scroll-table" v-scrolltable="">
      ...
      <tbody>
        <tr v-for="app in sortedTools">
          ...
          <td v-tooltip.bottom-center="app.versioning.surveyRaw2017 + ' votes in 2017<br>Design Tools Survey'">
            <a href="/survey-2017" style="display: block;">
              <div 
                v-bind:class="[{'blue-bar' : app.versioning.surveyRaw2017}, 'bar']" 
                v-bind:style="{ width: app.versioning.surveyPercent2017 + '%' }">
              </div>
            </a>
          </td>
          <td class="colspan-3">
