    ...
    <table id="scroll-table" v-scrolltable="">
      ...
      <tbody>
        <tr v-for="app in sortedTools">
          ...
          <check-box-table-cell :tool-property="app.design.penTool"></check-box-table-cell>
          <check-box-table-cell :tool-property="app.design.collaboration"></check-box-table-cell>
          <check-box-table-cell :tool-property="app.design.comments"></check-box-table-cell>
          <check-box-table-cell :tool-property="app.design.handoff"></check-box-table-cell>
          <check-box-table-cell :tool-property="app.design.artboards"></check-box-table-cell>
          <check-box-table-cell :tool-property="app.design.symbols"></check-box-table-cell>
          <check-box-table-cell :tool-property="app.design.responsive"></check-box-table-cell>
          <check-box-table-cell :tool-property="app.design.prototyping"></check-box-table-cell>
        </tr>
      </tbody>
    </table>
