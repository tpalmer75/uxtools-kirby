    ...
    <table id="scroll-table" v-scrolltable="">
      ...
      <tbody>
        <tr v-for="app in sortedTools">
          ...
          <check-box-table-cell :tool-property="app.prototyping.design"></check-box-table-cell>
          <td class="colspan-5">
            <div class="flex-col">
          ...
          <check-box-table-cell :tool-property="app.prototyping.micro"></check-box-table-cell>
          <check-box-table-cell :tool-property="app.prototyping.transition"></check-box-table-cell>
          <check-box-table-cell :tool-property="app.prototyping.data"></check-box-table-cell>
          <check-box-table-cell :tool-property="app.prototyping.code"></check-box-table-cell>
          <check-box-table-cell :tool-property="app.prototyping.inputs"></check-box-table-cell>
          <check-box-table-cell :tool-property="app.prototyping.variables"></check-box-table-cell>
          <td class="colspan-8">
            <div class="flex-col">
          ...
          <check-box-table-cell :tool-property="app.prototyping.handoff"></check-box-table-cell><check-box-table-cell :tool-property="app.prototyping.sensors"></check-box-table-cell><check-box-table-cell :tool-property="app.prototyping.voice"></check-box-table-cell><check-box-table-cell :tool-property="app.prototyping.tasks"></check-box-table-cell><check-box-table-cell :tool-property="app.prototyping.analytics"></check-box-table-cell><check-box-table-cell :tool-property="app.prototyping.heatmaps"></check-box-table-cell>
